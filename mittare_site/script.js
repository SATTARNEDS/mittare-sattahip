...
const officialRateSources = {
  compulsory: {
    label: "อัตราเบี้ยประกันภัยภาคบังคับ (พ.ร.บ.) สำหรับรถยนต์และรถจักรยานยนต์ที่มิตรแท้เผยแพร่",
...
const categoryMeta = {
  motor: {
    title: "รถยนต์และรถจักรยานยนต์",
    description: "เลือกดูประกันรถยนต์ประเภท 1, 2, 3, 2+, 3+ และตรวจอัตรา พ.ร.บ. สำหรับทั้งรถยนต์และรถจักรยานยนต์",
    image: "assets/insurance-motor.png",
    alt: "ยานยนต์ สื่อถึงประกันรถยนต์และรถจักรยานยนต์"
  },
  property: {
