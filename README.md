...
- ส่ง LINE Push ไปยังผู้ดูแลจากแดชบอร์ดได้เมื่อมี `LINE_CHANNEL_ACCESS_TOKEN` และบันทึก `LINE User ID ผู้ดูแล`
- Export JSON จากฐานข้อมูลเพื่อสำรองข้อมูล
- เพิ่มข้อมูลตัวอย่างสำหรับทดสอบหน้าลูกค้า

## ตั้งค่า LINE Push เพื่อแจ้งผู้ดูแล

LINE Push ใช้ LINE Messaging API และต้องมี `LINE User ID ผู้ดูแล` ที่เพิ่มเพื่อนกับ LINE OA แล้ว ไม่สามารถส่งด้วย LINE ID, ชื่อบัญชี หรือ `@` username ได้โดยตรง
...
5. ให้ผู้ดูแลทัก LINE OA อย่างน้อย 1 ข้อความ
6. ในหลังบ้าน บันทึก `LINE User ID ผู้ดูแล`
7. กด `ส่งแจ้งเตือนผู้ดูแล` เพื่อส่งสรุปงานหมดอายุ/ใกล้หมดอายุ/นัดติดตามไปยังผู้ดูแล
8. หรือเลือกกรมธรรม์หนึ่งรายการ แล้วกด `ส่งให้ผู้ดูแล` เพื่อส่งข้อความเฉพาะรายการนั้น
...
กด `ใช้เป็นผู้ดูแล` เพื่อใส่ `LINE User ID` ลงช่องผู้ดูแล แล้วกดบันทึกก่อนทดสอบ Push
